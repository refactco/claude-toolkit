...
1. The branch named in `agent/AGENTS.md` (look for a "Branches & PRs" / base-branch note).
...
| **Base branch wrong/unknown.** | Re-run Step 1b; ask once; record the answer in `agent/AGENTS.md`. |
