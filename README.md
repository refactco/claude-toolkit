...
|---|---|---|
| **base** | `/plugin install base@refact-os` | git workflow, code-dev gates, Asana, env-var sync, learnings capture, slim project config, the `/refact` command, TS/JS language server |
| **client** | `/plugin install client@refact-os` | discovery-first proposals, headline-first client updates, branded print-ready PDF rendering |
