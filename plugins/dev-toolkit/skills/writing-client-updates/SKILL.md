...
when_not_to_use: Internal team updates or retrospectives; formal project reports; CHANGELOG entries; commit messages.
inputs:
  - raw notes or a summary of the situation (what was found, what was done, what comes next)
  - the channel: email or Slack
outputs:
  - a structured client update ready to send, following the headline-first format in the reference
next_skills: []
sub_agents: []
---
...
4. Offer to tighten or adjust tone before the user sends it.

## The core principle

Lead with the answer, not the history. The client needs to know **where things stand right now** in the first sentence — everything else supports that sentence.
